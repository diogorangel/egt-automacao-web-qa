...
@CucumberOptions(plugin = {"pretty",
               ...
               features = "classpath:features/001_EGT_GerenciamentoAnexos.feature",
               snippets = SnippetType.CAMELCASE,
             monochrome = true,
             glue = {"steps","br.com.bb.egt.web_qa.utilitarios"},
             tags = {"@004_EGT_GerenciamentoAnexos_InclusaoExtensaoAssinaturaDocumentosSolicitacaoContabil"}
				)

public class EGTGerenciamentoAnexosTest {
