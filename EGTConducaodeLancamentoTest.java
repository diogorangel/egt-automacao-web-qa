...
@CucumberOptions(plugin = {"pretty",
               ...
               features = "classpath:features/004_EGT_ConducaoLancamentoContabil.feature",
               snippets = SnippetType.CAMELCASE,
	           monochrome = true,
	           glue = {"steps","br.com.bb.egt.web_qa.utilitarios"},
	           tags = {"@002_EGT_ValidarTelaRegraSolicitacaoLancamento_Teste"}
				)

public class EGTConducaodeLancamentoTest {
